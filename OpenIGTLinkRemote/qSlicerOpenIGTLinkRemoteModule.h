...
#ifndef __qSlicerOpenIGTLinkRemoteModule_h
#define __qSlicerOpenIGTLinkRemoteModule_h
...
protected:
  QScopedPointer<qSlicerOpenIGTLinkRemoteModulePrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qSlicerOpenIGTLinkRemoteModule);
  Q_DISABLE_COPY(qSlicerOpenIGTLinkRemoteModule);
